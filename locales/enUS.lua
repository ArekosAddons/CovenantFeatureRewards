...
L.COVENANT_REWARDS_UNOBTAINABLE_DD = "Unobtainable covenant rewards |cFFFFFFFF%d/%d|r"
L.SHARED_REWARDS_UNOBTAINABLE_DD = "Unobtainable shared rewards |cFFFFFFFF%d/%d|r"
L.COVENANT_REWARDS_EXTRA = "Obtainable covenant rewards"
L.SHARED_REWARDS_EXTRA = "Obtainable shared rewards"
